create or replace view PS_TASK_IMP_VW as
select /*$Id: CRE_PS_TASK_IMP_VW.sql,v 1.7 2014/08/04 19:25:10 olando Exp $*/
       pe.env_id,
       pp.gpms_exp_id,
       pt.task_id,
       pt.project_id,
...
/*select * from ps_task_imp_vw;
select * from ps_task;        -- 8599
select * from ps_project;     -- 13353
select * from ps_env_activity;  -- 9

delete from ps_task_imp_vw;

select * from user_updatable_columns where table_name = 'PS_TASK_IMP_VW'
;
*/
